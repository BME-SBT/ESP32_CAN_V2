...
//323776/1829388/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPS25921ADR" (originalName "TPS25921ADR")
	...
	(compDef "TPS25921ADR" (originalName "TPS25921ADR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "GND") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "SS") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "ENUV") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "IN") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "OVP") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "ILIM") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "__FLT") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "OUT") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS25921ADR"))
		...
		(attr "Mouser Part Number" "595-TPS25921ADR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS25921ADR?qs=m%2F7bTylgptfvwfVPRm0ALQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS25921ADR")
		(attr "Description" "18V, 1.6A, 90m eFuse with Adjustable +/-2% Accurate Current Limit")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tps25921a")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TPS25921ADR.stp")
